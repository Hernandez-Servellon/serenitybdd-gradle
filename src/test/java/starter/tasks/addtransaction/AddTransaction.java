...
public class AddTransaction {
    public static Performable withInfo(String transactionDate, String transactionAmaunt, String transactionDescription){
        return Task.where("{0} adds a new transaction",
                ...
                Enter.theValue(transactionAmaunt).into(AddTransactionPage.INPUT_AMOUNT),
